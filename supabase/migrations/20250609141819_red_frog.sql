...
-- Run this in your Supabase SQL Editor: https://supabase.com/dashboard/project/nnqqdlrarfdjmyjsxxrw/sql
...
-- Go to Storage → Create bucket → Name: "print-files" → Public: true
...
-- Next steps:
-- 1. Create storage bucket "print-files" in Supabase dashboard
-- 2. Test the connection from your desktop app
-- 3. Start receiving real-time orders from your web app!